...
VALUES
('Complete Blood Count (CBC)', 'Blood cell analysis'),
('Lipid Profile', 'Cholesterol and triglyceride evaluation'),
('Diabetes Screening', 'Blood glucose and HbA1c evaluation'),
('Liver Function Test', 'Liver enzyme assessment'),
('Kidney Function Test', 'Kidney health assessment'),
('Urinalysis', 'Urine laboratory examination'),
('Thyroid Function Test', 'Thyroid hormone assessment'),
('COVID-19 PCR', 'Coronavirus PCR test'),
('Comprehensive Metabolic Panel', 'General metabolic health assessment');

INSERT INTO testresult
(testResultID, userID, testTypeID, doctorID,
 title, datetime, testResultCode, remarks)
VALUES
(1,2,2,1,
...
(testResultID, parameterName, resultValue, unit, referenceRange, abnormalFlag)
VALUES

(1,'Total Cholesterol','225','mg/dL','<200','High'),
(1,'HDL Cholesterol','42','mg/dL','>40','Normal'),
(1,'LDL Cholesterol','145','mg/dL','<100','High'),
(1,'Triglycerides','185','mg/dL','<150','High');

INSERT INTO testresult_item
(testResultID, parameterName, resultValue, unit, referenceRange, abnormalFlag)
VALUES

(2,'Blood Glucose','102','mg/dL','70-100','High'),
(2,'Sodium','139','mmol/L','135-145','Normal'),
(2,'Potassium','4.3','mmol/L','3.5-5.1','Normal'),
(2,'Calcium','9.4','mg/dL','8.6-10.2','Normal');

INSERT INTO testresult_item
(testResultID, parameterName, resultValue, unit, referenceRange, abnormalFlag)
VALUES

(3,'Blood Glucose','186','mg/dL','70-100','High'),
(3,'HbA1c','8.2','%','<5.7','High'),
(3,'Insulin','8.5','uIU/mL','2.6-24.9','Normal');

INSERT INTO testresult_item
(testResultID, parameterName, resultValue, unit, referenceRange, abnormalFlag)
VALUES

(4,'Creatinine','1.4','mg/dL','0.7-1.3','High'),
(4,'BUN','24','mg/dL','7-20','High'),
(4,'eGFR','72','mL/min','>60','Normal'),
(4,'Uric Acid','6.2','mg/dL','3.4-7.0','Normal');
